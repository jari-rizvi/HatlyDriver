...
class PastParcelAdapter(val arrayList: ArrayList<com.teamx.hatlyDriver.data.dataclasses.pastParcels.Doc>) : RecyclerView.Adapter<PastParcelAdapter.TopProductViewHolder>() {
